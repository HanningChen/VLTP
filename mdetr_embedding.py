...
from utils.dataset import HybridDataset, ValDataset, collate_fn, ValRIODataset
...
def train(
    ...
    for index, input_dict in enumerate(tqdm.tqdm(train_loader)):
        ...
        #NOTE: Hanning, for mdetr training
        input_dict["generate_embedding"] = True
